...
Sample `SYN-0002`, printed in small type at the bottom right of each page. Two pages. A natural gas bill from a fictional retailer, Example Energy, to Mrs M A Wilson, for the two months from 1 August to 30 September 2026. The answer key is [`ground-truth.json`](ground-truth.json).
...
- **Energy Retail Code of Practice, version 7** (Essential Services Commission, Victoria). The bill is issued on 19 October 2026, so it falls under version 7, which took effect on 1 October 2026. Clause 63 is the list of everything a Victorian gas bill must show, and it is the same clause that covers electricity bills. It gave the amount due, the pay-by date, the account details with the gas meter number (MIRN), the complaints service on page 1, the distributor's name and 24 hour gas emergency line, interpreter services, and the note about government concessions. The same clause says some items are for electricity bills only, so this bill has no Victorian Default Offer sentence, no greenhouse gas figures and no comparison with similar households. Clause 65 set the pay-by date at least 13 business days after the issue date. The Code defines a business day as a day that is not a Saturday, a Sunday or a public holiday appointed under the Public Holidays Act 1993 (Vic), so Melbourne Cup Day, 3 November 2026, is not counted. Clause 72 gave the payment methods. Clause 72 changed in version 7: a new clause 72(2A) says a retailer must offer at least one payment method that is commonly used and accessible and has no charges, and clause 72(7) applies clauses 72(1) and 72(2A) to market retail contracts entered into on or after 1 October 2026. The payment methods printed on page 1 already meet it: in person, by telephone, by mail, by direct debit and by electronic funds transfer, with no fee printed for any of them. Clause 111 gave the box saying she is on one of the lowest priced plans, and the rule that this box must name a price comparison service. Clause 110 says a gas customer's plan is checked at least once every four months, and the box says so. Clauses 63, 65, 110 and 111 and the definition of a business day read the same as in version 6. Clause 109 did change: from 1 October 2026 the best offer threshold is \$50, up from \$22. The link is the version 7 text with tracked changes, because the regulator has not yet posted a clean copy. <https://www.esc.vic.gov.au/sites/default/files/documents/Energy%20Retail%20Code%20of%20Practice%20%28version%207%29%20-%20TRACKED%20CHANGES%20%28final%20version%29.pdf>
...
**2026-11-06.** Page 1, top left box, "Pay by 06/11/2026". The same date is repeated in the "Your account" table ("Pay by") and at the bottom right of the tear-off slip ("PAY BY"). The pay-by date is the date the payment is due. The page writes it day first, the Australian way; the answer key writes it as year, month, day.

### amount

**\$257.36.** Page 1, top left box, "TOTAL AMOUNT DUE \$257.36". It is also the last line of "Account summary" on the right ("TOTAL AMOUNT DUE") and "AMOUNT DUE" on the tear-off slip. The same figure appears as "Total of current charges" in the Account summary and in the last row of "Your gas charges" on page 2. It is the whole amount she has to pay. Her last bill of \$298.34 was paid, so the Account summary carries forward \$0.00. Page 2 works out the charges as \$307.57 of gas charges less a \$50.21 winter gas concession.
